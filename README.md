...
```python
from hide_and_seek_engine.env_wrapper import convert_map
...
```python
from hide_and_seek_engine.env_wrapper import FeatureType
...
```python
import numpy as np
from hide_and_seek_engine.env_wrapper import BatchedGridEnv
