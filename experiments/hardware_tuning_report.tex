...
\begin{enumerate}
    ...
    \item \textbf{Iteration:} Every hardware configuration was executed identically \textbf{six (6) times}.
...
\midrule
\textbf{Control} (Default settings) & Default & 0 & N/A & 18,379 $\pm$ 421 & 40.3\% $\pm$ 0.9\% \\
\textbf{Test A} (Thread Limit) & Default & 1 & N/A & 18,829 $\pm$ 123 & 38.5\% $\pm$ 0.7\% \\
\textbf{Test B} (Yield Cores) & Passive & 0 & N/A & 17,719 $\pm$ 173 & 37.3\% $\pm$ 1.1\% \\
\textbf{Test C} (Limit + Yield) & Passive & 1 & N/A & \textbf{18,904 $\pm$ 168} & 38.4\% $\pm$ 0.7\% \\
\textbf{Aligned} (PCIe nodes) & Default & 1 & Aligned & 18,889 $\pm$ 163 & 38.5\% $\pm$ 0.8\% \\
\textbf{Misaligned} (Cross-Fabric) & Default & 1 & Misaligned & 18,133 $\pm$ 166 & 39.1\% $\pm$ 0.8\% \\
\textbf{BEST SCENARIO} (Aligned + Test C) & Passive & 1 & Aligned & \textbf{18,904 $\pm$ 168} & 38.4\% $\pm$ 0.7\% \\
\textbf{WORST SCENARIO} (Misaligned) & Default & 0 & Misaligned & 14,221 $\pm$ 1726 & 27.5\% $\pm$ 9.1\% \\
\bottomrule
\end{tabular}
...
The "Best Case" and "Worst Case" tests purposely restrict the process to 32 logical cores (1 NUMA node) using \texttt{taskset}, compared to the 128 logical cores used in the unstructured tests. While raw SPS is marginally lower (14.2k vs 18.9k), the \textit{per-core computational efficiency} is massively optimized. The Best Case achieves nearly the same throughput with 25\% of the hardware footprint and doubles GPU execution density (44.8\% vs 17.4\%). 
